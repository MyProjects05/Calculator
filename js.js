...
// function updateFirstVariable(event){
//     if (firstOrSecond){
//         updateThirdVariable(event);
//         return
//     }
...
// function updateThirdVariable(event){
//     if (!firstOrSecond){
//         updateFirstVariable(event);
//         return
//     }
//     if (isDigitCharCode(event.target.firstElementChild.textContent)){
//         firstOrSecond = false;
//         updateFirstVariable(event)
//     }
//     secondOperand = event.target.firstElementChild.textContent;
//     screen.textContent += SecondOperand;
//     firstOperand = operate(firstOperand, operation, secondOperand);
// }
